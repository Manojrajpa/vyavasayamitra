...
This project is a **WhatsApp-based advisory assistant** for farmers that processes incoming **text**, **image**, and **audio** messages and responds with intelligent replies using your AI backend.
...
- The message is forwarded to an **AI backend** (Google ADK model).
...
- To use it:
  1. Join the sandbox by sending a message to the temporary business number.
